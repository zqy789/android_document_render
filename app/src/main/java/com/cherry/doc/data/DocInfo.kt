...
class DocInfo {
    ...
    fun getTypeIcon(): Int {
        if (fileName?.lowercase()?.endsWith("pdf") == true) {
            return com.document.render.R.drawable.pdf_ic
        }
        if (fileName?.lowercase()?.endsWith("doc") == true) {
            return com.document.render.R.drawable.file_doc
        }
        if (fileName?.lowercase()?.endsWith("docx") == true) {
            return com.document.render.R.drawable.file_docx
        }
        if (fileName?.lowercase()?.endsWith("xls") == true) {
            return com.document.render.R.drawable.file_xls
        }
        if (fileName?.lowercase()?.endsWith("xlsx") == true) {
            return com.document.render.R.drawable.file_xlsx
        }
        if (fileName?.lowercase()?.endsWith("ppt") == true) {
            return com.document.render.R.drawable.ppt_ic
        }
        if (fileName?.lowercase()?.endsWith("pptx") == true) {
            return com.document.render.R.drawable.file_pptx
        }
        if (fileName?.lowercase()?.endsWith("txt") == true) {
            return com.document.render.R.drawable.file_txt
        }
        return -1
    }
