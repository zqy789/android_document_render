package com.document.render.widget
...
import com.document.render.bean.DocEngine
import com.document.render.bean.DocMovingOrientation
import com.document.render.bean.DocSourceType
import com.document.render.bean.FileType
import com.document.render.interfaces.OnDocPageChangeListener
import com.document.render.interfaces.OnDownloadListener
import com.document.render.interfaces.OnPdfItemClickListener
import com.document.render.interfaces.OnWebLoadListener
import com.document.render.office.IOffice
import com.document.render.pdf.PdfDownloader
import com.document.render.pdf.PdfPageViewAdapter
import com.document.render.pdf.PdfQuality
import com.document.render.pdf.PdfRendererCore
import com.document.render.pdf.PdfViewAdapter
import com.document.render.util.Constant
import com.document.render.util.FileUtils
import com.document.render.util.ViewUtils.hide
import com.document.render.util.ViewUtils.show
import kotlinx.android.synthetic.main.doc_view.view.mDocWeb
import kotlinx.android.synthetic.main.doc_view.view.mFlDocContainer
import kotlinx.android.synthetic.main.doc_view.view.mIvImage
import kotlinx.android.synthetic.main.doc_view.view.mIvPdf
import kotlinx.android.synthetic.main.doc_view.view.mLlBigPdfImage
import kotlinx.android.synthetic.main.doc_view.view.mPbBigLoading
import kotlinx.android.synthetic.main.doc_view.view.mPdfPageNo
import kotlinx.android.synthetic.main.doc_view.view.mPlLoadProgress
import kotlinx.android.synthetic.main.doc_view.view.mRvPdf
import java.io.File
...
class DocView : FrameLayout, OnDownloadListener, OnWebLoadListener, OnPdfItemClickListener {
    ...
    fun initView(attrs: AttributeSet?, defStyle: Int) {
        ...
        val orientation =
            typedArray.getInt(
                R.styleable.DocView_dv_moving_orientation,
                DocMovingOrientation.HORIZONTAL.orientation
            )
