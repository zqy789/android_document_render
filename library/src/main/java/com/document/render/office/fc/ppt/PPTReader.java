...
import com.document.render.office.fc.hslf.model.Fill;
import com.document.render.office.fc.hslf.model.HeadersFooters;
import com.document.render.office.fc.hslf.model.Line;
import com.document.render.office.fc.hslf.model.MasterSheet;
import com.document.render.office.fc.hslf.model.Notes;
import com.document.render.office.fc.hslf.model.Shape;
import com.document.render.office.fc.hslf.model.ShapeGroup;
import com.document.render.office.fc.hslf.model.Sheet;
import com.document.render.office.fc.hslf.model.SimpleShape;
import com.document.render.office.fc.hslf.model.Slide;
import com.document.render.office.fc.hslf.model.SlideMaster;
import com.document.render.office.fc.hslf.model.TextShape;
import com.document.render.office.fc.hslf.model.TitleMaster;
import com.document.render.office.fc.hslf.record.BinaryTagDataBlob;
import com.document.render.office.fc.hslf.record.ClientVisualElementContainer;
...
import com.document.render.office.fc.hslf.record.SlideAtom.SSlideLayoutAtom;
import com.document.render.office.fc.hslf.record.SlideProgBinaryTagContainer;
...
import com.document.render.office.fc.hslf.record.TimeAnimateBehaviorContainer;
import com.document.render.office.fc.hslf.record.TimeBehaviorContainer;
import com.document.render.office.fc.hslf.record.TimeColorBehaviorContainer;
import com.document.render.office.fc.hslf.record.TimeCommandBehaviorContainer;
import com.document.render.office.fc.hslf.record.TimeEffectBehaviorContainer;
import com.document.render.office.fc.hslf.record.TimeMotionBehaviorContainer;
import com.document.render.office.fc.hslf.record.TimeNodeAttributeContainer;
import com.document.render.office.fc.hslf.record.TimeNodeContainer;
import com.document.render.office.fc.hslf.record.TimeRotationBehaviorContainer;
import com.document.render.office.fc.hslf.record.TimeScaleBehaviorContainer;
import com.document.render.office.fc.hslf.record.TimeSetBehaviorContainer;
import com.document.render.office.fc.hslf.record.TimeVariant;
import com.document.render.office.fc.hslf.record.VisualShapeAtom;
...
public class PPTReader extends AbstractReader {
    ...
    private com.document.render.office.common.borders.Line getShapeLine(SimpleShape shape) {
        return getShapeLine(shape, false);
    }

    private com.document.render.office.common.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine) {
        com.document.render.office.common.borders.Line line = null;
        if (shape != null && shape.hasLine()) {
            ...
            com.document.render.office.java.awt.Color color = ((SimpleShape) shape).getLineColor();

            if (color != null) {
                line = new com.document.render.office.common.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill) {
        ...
        if (fill != null) {
            ...
            if (type == BackgroundAndFill.FILL_BACKGROUND) {
                ...
                com.document.render.office.java.awt.Color fillColor = fill.getForegroundColor();
                com.document.render.office.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes) {
        if (notes != null) {
            ...
            for (Shape shape : notes.getShapes()) {
                ...
                if (shape instanceof com.document.render.office.fc.hslf.model.AutoShape
                        || shape instanceof com.document.render.office.fc.hslf.model.TextBox)
                {
    ...
    private void processShape(PGSlide pgSlide, GroupShape parent, Shape shape, int slideType) {
        ...
        if (shape instanceof Line
                || shape instanceof com.document.render.office.fc.hslf.model.Freeform
                || shape instanceof com.document.render.office.fc.hslf.model.AutoShape
                || shape instanceof com.document.render.office.fc.hslf.model.TextBox
                || shape instanceof com.document.render.office.fc.hslf.model.Picture) {
            if (shape instanceof Line) {
                if (line != null) {
            ...
            } else if (shape instanceof com.document.render.office.fc.hslf.model.Freeform) {
                if (fill != null || line != null) {
                    ...
                    if (startArrowType > 0) {
                        ArrowPathAndTail arrowPathAndTail = ((com.document.render.office.fc.hslf.model.Freeform) shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0) {
                        ArrowPathAndTail arrowPathAndTail = ((com.document.render.office.fc.hslf.model.Freeform) shape).getEndArrowPathAndTail(rect);
                        if (arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null) {
                    ...
                    Path[] paths = ((com.document.render.office.fc.hslf.model.Freeform) shape).getFreeformPath(rect,
            ...
            } else if (shape instanceof com.document.render.office.fc.hslf.model.AutoShape
                    || shape instanceof com.document.render.office.fc.hslf.model.TextBox) {
            ...
            else if (shape instanceof com.document.render.office.fc.hslf.model.Picture) {
                com.document.render.office.fc.hslf.model.Picture poiPic = (com.document.render.office.fc.hslf.model.Picture) shape;
        ...
        } else if (shape instanceof com.document.render.office.fc.hslf.model.Table) {
            com.document.render.office.fc.hslf.model.Table poiTable = (com.document.render.office.fc.hslf.model.Table) shape;
            if (poiTable != null) {
    ...
    private void processTable(PGSlide pgSlide, com.document.render.office.fc.hslf.model.Table poiTable, GroupShape parent, int slideType) {
        ...
        for (int i = 0; i < rows; i++) {
            for (int j = 0; j < columns; j++) {
                ...
                com.document.render.office.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null) {
        ...
        for (Line line : borders) {
            com.document.render.office.common.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null) {
    ...
    private int getBorderColor(Line line) {
        if (line != null) {
            com.document.render.office.java.awt.Color color = line.getLineColor();
            if (color != null) {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID) {
        ...
        if (text != null && text.trim().length() > 0) {
            ...
            int len = text.length();
            com.document.render.office.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;

            if (ts.getTextRun().getRunType() != com.document.render.office.fc.hslf.record.TextHeaderAtom.TITLE_TYPE) {
                for (int i = 0; i < len; i++) {
                    if (abortReader) {
                        break;
                    }
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
                                  com.document.render.office.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID) {
        ...
        com.document.render.office.fc.hslf.record.TextRulerAtom ruler = ts.getTextRun().getTextRuler();
        if (ruler != null) {
    ...
    private int converterColor(com.document.render.office.java.awt.Color color) {
